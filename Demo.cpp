...
void Demo::BuildColoredCube() {
	...
	unsigned int indices[] = {
		...
		20, 21, 22, 20, 22, 23,	// gagang belakang
		24, 25, 26, 24, 26, 27, // gagang samping kanan
		28, 29, 30, 28, 30, 31, // gagang depan
		32, 33, 34, 32, 34, 35,	// gagang samping kiri
		36, 37, 38, 36, 38, 39, // gagang upper
	};
